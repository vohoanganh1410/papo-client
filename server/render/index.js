...
import { isSectionIsomorphic } from 'client/state/ui/selectors';
import {
...
import { SERIALIZE } from 'client/state/action-types';
...
export function serverRender( req, res ) {
	...
	if ( context.store ) {
		...
		context.isRTL = false; // isLocaleRTL !== null ? isLocaleRTL : context.isRTL;
	}
