...
// import scrollbleed from 'telesale/chat-composer/scrollbleed';
// import Avatar from 'components/avatar';

// import debugFactory from 'debug';
// const debug = debugFactory( 'papo:conversation:timeline' );
...
// 	// alert( 'item' );
// 	// make user for display Avatar
// 	const user = {
// 		facebookId: event.from ? event.from.id : '103817703918246',
// 		displayName: event.from ? event.from.name : "Test User",
// 	}
// 	// alert('s')
// 	return (
// 		<div>
// 			<div className={ classnames( 'timeline__item', {
// 						'is-from-page': isCurrentUser,
// 					} ) }>
// 				<div className="timeline__avatar">
// 					{ ! isCurrentUser && <Avatar user={ user } /> }
// 				</div>
...
// const itemTypeIs = type => ( { item: [ firstItem ] } ) => true /*firstItem.type === type*/;
...
// 			const message_user_id = message.from ? message.from.id : '103817703918246';
// 			const message_type = message.type;
// 			const message_source = message.from ? message.from.id : '103817703918246';
// 			debug( 'compare source', message_source, message.source );
// 			if ( user_id !== message_user_id ||  message_source !== source ) {
// 				return {
