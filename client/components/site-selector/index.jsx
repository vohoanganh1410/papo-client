...
// import AllSites from 'dashboard/all-sites';
...
// const debug = debugFactory( 'papo:site-selector' );
...
// 		const handledByHost = null;//this.props.onSiteSelect( siteId );
...
// 		const postsBase = site.jetpack || site.single_user_site ? '/orders' : '/orders';

// 		// Default posts to /posts/my when possible and /posts when not
// 		path = path.replace( /^\/orders\b(\/my)?/, postsBase );
