...
SidebarNavigation.propTypes = {
	title: PropTypes.string, //TranslatableString
	linkClassName: PropTypes.string,
	sectionTitle: PropTypes.string, //TranslatableString
	sectionName: PropTypes.string, //PropTypes.string.isRequired,
	setLayoutFocus: PropTypes.func.isRequired, //PropTypes.func.isRequired,
};
