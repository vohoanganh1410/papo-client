...
export default class AutosizeTextarea extends React.Component {
	...
	render() {
		...
		Reflect.deleteProperty( props, 'pages' );
		Reflect.deleteProperty( props, 'snippets' );
		Reflect.deleteProperty( props, 'inputContainerClasses' );
		Reflect.deleteProperty( props, 'resultHeaderRenderer' );
		...
		return (
			<div className={ this.props.inputContainerClasses }>
				<textarea
					ref="textarea"
					id={ id }
					{ ...heightProps }
