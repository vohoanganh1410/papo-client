...
const debug = debugFactory( 'papo:site-users-fetcher' );
...
export default class extends React.Component {
	...
	static propTypes = {
		...
		exclude: PropTypes.oneOfType( [ PropTypes.arrayOf( PropTypes.string ), PropTypes.func ] ),
	};
		...
		if ( this.props.exclude ) {
			...
			users = partition(
				...
				function( user ) {
					...
					return ! includes( this.props.exclude, user._id );
				}.bind( this )
			);
		}
