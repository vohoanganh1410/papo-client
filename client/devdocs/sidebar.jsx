...
export default class DevdocsSidebar extends React.PureComponent {
	...
	render() {
		return (
			<Sidebar>
				<a href="/devdocs">
					<h1 className="devdocs__title">Papo Docs</h1>
				</a>
				<SidebarMenu>
					<ul>
						<SidebarItem
				...
				<SidebarHeading>Dành cho nhà phát triển</SidebarHeading>
				<SidebarMenu>
					<ul>
						<SidebarItem
							className="devdocs__navigation-item"
							...
							link="/devdocs/docs/development/index.md"
							selected={ this.isItemSelected( '/devdocs/docs/development', false ) }
						/>
						<SidebarItem
							className="devdocs__navigation-item"
							icon="pencil"
