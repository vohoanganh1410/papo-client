...
import SizedPlayer from './sized-player';
	...
	render = () => {
		...
		return (
			...
			>
				...
				<Overlay shown={ this.state.overlayShown } onClick={ playing ? this.onPause : this.onPlay }>
					<PlayButton>{ playing ? <PauseIcon /> : <PlayIcon /> }</PlayButton>
					<InnerOverlay />
				</Overlay>
			</Player>
		);
