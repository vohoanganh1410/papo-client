...
class SearchInput extends React.Component {
	...
	shouldComponentUpdate( r ) {
		var t =
			this.props.usePrimarySearch &&
			r.isSearchAutocompleteOpen !== this.props.isSearchAutocompleteOpen;
		return (
			t ||
			this.props.displayQuery !== r.displayQuery ||
			this.props.autocompleteSelectedIndex !== r.autocompleteSelectedIndex
		);
	}
	...
	updateDisplayQuery() {
		this.texty &&
			this.props.displayQuery !== this.getTextyString() &&
			this.texty.value( this.props.displayQuery );
	}
