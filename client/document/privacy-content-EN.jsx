...
export default class PrivacyEn extends React.PureComponent {
	render() {
		return (
			<div className="privacy__content">
				<p>
					<em>Effective date: September 10, 2018. Last changes: September 16, 2018</em>
				</p>
				<p>Papo ("us", "we", or "our") operates the papovn.com website (the "Service").</p>
				<p>
				...
				<p>
					...
					as in our Terms and Conditions, accessible from papovn.com
				</p>
				<h2 className="privacy__header">Facebook App Permissions</h2>
				<p>
					The app will need following permissions from your Facebook account to function normally.
					You will be prompted to ask for these permissions upon first login to our app. The app
					will not work correctly without any required permissions:
				</p>
				<ul>
					<li>
						<strong>manage_pages*:</strong> to retrieve the list and access token of Pages that you
						administrates
					</li>
					<li>
						<strong>publish_pages*:</strong> to reply comment, like comment on behalf of Pages that
						you manage
					</li>
					<li>
						<strong>read_page_mailboxes*, pages_messaging*:</strong> to read, receive and reply to
						Pages' messages
					</li>
					<li>
						<strong>business_management (optional):</strong> to manage your business assets
					</li>
					<li>
						<strong>pages_messaging_subscriptions*:</strong> to send messages using Facebook Pages
						at any time after the first user interaction
					</li>
				</ul>
				<h2 className="privacy__header">Information Collection And Use</h2>
				<p>
					We collect several different types of information for various purposes to provide and
					improve our Service to you.
				</p>
				<h3 className="privacy__sub-header">Types of Data Collected</h3>
				<h4 className="privacy__sub-sub-header">Personal Data</h4>
				<p>
				...
				<h4 className="privacy__sub-sub-header">Usage Data</h4>
				<p>
				...
				<h4 className="privacy__sub-sub-header">Tracking & Cookies Data</h4>
				<p>
				...
				<h2 className="privacy__header">Use of Data</h2>
				<p>Papo uses the collected data for various purposes:</p>
				<ul>
				...
				<h2 className="privacy__header">Transfer Of Data</h2>
				<p>
				...
				<p>
					...
					that we transfer the data, including Personal Data, to Viet Nam and process it there.
				</p>
				<p>
				...
				<p>
					Papo will take all steps reasonably necessary to ensure that your data is treated securely
				...
				<h2 className="privacy__header">Disclosure Of Data</h2>
				<h3 className="privacy__sub-header">Legal Requirements</h3>
				<p>
					Papo may disclose your Personal Data in the good faith belief that such action is
					necessary to:
				</p>
				<ul>
					<li>To comply with a legal obligation</li>
					<li>To protect and defend the rights or property of Papo</li>
					<li>To prevent or investigate possible wrongdoing in connection with the Service</li>
					<li>To protect the personal safety of users of the Service or the public</li>
					<li>To protect against legal liability</li>
				</ul>
				<h2 className="privacy__header">Security Of Data</h2>
				<p>
				...
				<h2 className="privacy__header">Service Providers</h2>
				<p>
				...
				<h3 className="privacy__sub-header">Analytics</h3>
				<p>
				...
				<h2 className="privacy__header">Links To Other Sites</h2>
				<p>
				...
				<h2 className="privacy__header">Children's Privacy</h2>
				<p>
					do not address anyone under the age of 13. We do not knowingly collect personally
					...
					with personal information, please contact us so that we will be able to do necessary
					actions.
				</p>
				<p>
				...
				<h2 className="privacy__header">Changes To This Privacy Policy</h2>
				<p>
				...
				<ul>
					<li>By email: admin@papovn.com</li>
				</ul>
			</div>
		);
	}
