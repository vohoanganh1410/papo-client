...
// import { camelCase, clone, isPlainObject, omit, pick, reject, snakeCase, map } from 'lodash';
// import debugFactory from 'debug';
// const debug = debugFactory( 'papo:wpcom-undocumented:undocumented' );
// import url from 'url';
...
//
// 	return this.wpcom.req.post(
// 		'/sites/' + invite.site_ID + '/invites/' + invite.invite_key + '/accept',
// 		{
...
//  * @api public
//  */
// Undocumented.prototype.orderStatuses = function( siteId, method = 'get', data = {}, fn ) {
// 	debug( '/sites/:site_id:/orderStatuses query' );
// 	if ( 'function' === typeof method ) {
// 		fn = method;
// 		method = 'get';
// 		data = {};
...
// 	const apiVersion = data.apiVersion || '1.1';
// 	const body = omit( data, [ 'apiVersion' ] );
// 	const path = '/sites/' + siteId + '/orderStatuses';
//
// 	if ( 'get' === method ) {
// 		return this.wpcom.req.get( path, { apiVersion }, fn );
// 	}
...
// 		return;
// 	}
// 	const contentWidth = /*readerContentWidth()*/150;
// 	if ( contentWidth ) {
 ...
 * @returns {Promise}                   A promise that resolves when the export started
 */
Undocumented.prototype.activePages = function( pages, fn ) {
	const pageIds = pages.map( page => page.id );
	alert( pageIds );
	return this.wpcom.req.post(
		{
			apiVersion: '1.1',
			path: `/pages/initialize`,
		},
		{
			pageId: pageIds,
		},
 ...
 * @returns {Promise}                   A promise that resolves when the export started
 */
Undocumented.prototype.listPages = function( fn ) {
	// const page_ids = pages && pages.length ? map( pages, page => page.id ) : null;
	return this.wpcom.req.get(
		{
			apiVersion: '1.0',
			path: '/fanpages',
 ...
 * @returns {Promise}                   A promise that resolves when the export started
 */
Undocumented.prototype.initPage = function( pageId, pageName, access_token, fn ) {
	return this.wpcom.req.post(
		{
			apiVersion: '1.1',
			path: `/pages/` + pageId + `/init`,
		},
		{
 ...
 * @returns {Promise}                   A promise that resolves when the export started
 */
Undocumented.prototype.checkPageInitializeStatus = function( page_id, fn ) {
	return this.wpcom.req.get(
		{
			apiVersion: '1.0',
			path: `/fanpages/` + page_id,
		},
		fn
	);
};
 ...
 * @returns {Promise}                   A promise that resolves when the export started
 */
Undocumented.prototype.listConversations = function( query, fn ) {
	return this.wpcom.req.get(
		{
			apiVersion: '1.0',
			path: '/conversations',
 ...
 * @returns {Promise}                   A promise that resolves when the export started
 */
Undocumented.prototype.fetchConversation = function( id, query, fn ) {
	// console.log( query );
	return this.wpcom.req.get(
		{
			apiVersion: '1.0',
...
Undocumented.prototype.getPageReplySnipests = function( page_id, fn ) {
	return this.wpcom.req.get(
		{
			apiVersion: '1.0',
			path: `/fanpages/${ page_id }/snippets`,
		},
		fn
	);
};

Undocumented.prototype.createSnippet = function( snippet, fn ) {
	return this.wpcom.req.post(
		{
			apiVersion: '1.0',
			path: `/fanpages/` + snippet.page_id + `/snippets`,
		},
		snippet,
		fn
	);
...
Undocumented.prototype.createAutoMessageTask = function( task, fn ) {
	return this.wpcom.req.post(
		{
			apiVersion: '1.0',
			path: `/fanpages/` + task.page_id + `/auto_message_tasks`,
		},
		task,
		fn
	);
...
Undocumented.prototype.getPageAutoMessageTasks = function( page_id, fn ) {
	return this.wpcom.req.get(
		{
			apiVersion: '1.0',
			path: `/fanpages/${ page_id }/auto_message_tasks`,
		},
		fn
	);
};
