...
function isDefaultOrNullQueryValue( value, key ) {
	return (
		null == value || DEFAULT_CONVERSATION_QUERY[ key ] === value // Double-equals null checks undefined, null
	);
}
 ...
 */
export default class ConversationQueryKey extends PaginatedQueryKey {
	/**
