			...
			( memo, queryDetails, queryKey ) => {
				...
				items.forEach( receivedItem => {
					...
					if ( -1 !== index ) {
						...
						// original code of Calypso is 
						//  updatedItem && this.constructor.matches( query, updatedItem )
						// but when I add realtime pretend request, the query is not real
						// so I omit matches of query and updatedItem
						// this maybe review in future
