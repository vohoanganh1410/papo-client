...
/***
 * Gets the page information of the social account given by pageId.
 *
 * @param  {Object}   state  Global state tree
 * @param  {Number}   pageId Facebook Page ID
 * @return {Object}   Facebook Page information.
 */
export const getPage = ( state, pageId ) => 
	get( state, 'login.socialPages', pageId );

/***
 * Gets the page access token of the social account given by pageId.
 *
 * @param  {Object}   state  Global state tree
 * @param  {Number}   pageId Facebook Page ID
 * @return {String}   Facebook Page access token.
 */
export const getPageAccessToken = ( state, pageId ) => {
