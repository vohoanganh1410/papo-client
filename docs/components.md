...
We write classes like `.my-component__element` to indicate the component an element belongs to. Thus, component names (the folder holding the `message-list.jsx` file) need to be written with a global scope, specific, and clear enough in meaning.
